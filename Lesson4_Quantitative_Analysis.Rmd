...
4. Multivariat linear models 
5. Hierarchical linear models
6. Uing model objects to predict things and validate models.
...
Let's change the Sex variable to be more represintitive of how we actually think of 'Sex' data.
...
The parameter estimate (for a standard linear model) tells us how much the dependant variable increases as a result of the independant variables.
...
They are whe we only usse Variable_4 though..This is a good lesson in model selection!
...
A better way to do this is to give each sex its own intercept, slope, or both. These will both be more representitive of reality.
